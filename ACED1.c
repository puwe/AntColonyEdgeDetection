...
void process_file(void)
{
        ...
        printf("%d ants are randomly dispatched.\n",K);*/
        ...
        printf("Initizlied heuristic information eta\n");
...
int main(int argc, char **argv)
{
        ...
        //char filein[64];
        //char fileout[64];
        //sprintf(filein, "tree.png");
        //sprintf(fileout, "test.png");
        srand(time(NULL));

        //read_png_file(filein);
        process_file();
        //write_png_file(fileout);
